...
class Net_teacher(nn.Module):   
    def __init__(self):
        ...
        #self.backbone = nn.Sequential(*(list(barlotwins.children())[:-2]))
        ...
        '''self.cnn_layers = Sequential(
            ...
            Conv2d(2048, 512, kernel_size=2, stride=1, padding=1),
            BatchNorm2d(512),
            ReLU(inplace=True),
            MaxPool2d(kernel_size=3, stride=1),
            #Defining another 2D convolution layer
            #Conv2d(512, 512, kernel_size=2, stride=1, padding=1),
            #BatchNorm2d(512),
            #ReLU(inplace=True),
...
chk_path = "student_10_simclr_gptpo_18_new_btcs.ckpt"
