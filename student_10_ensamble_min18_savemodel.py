...
class LightningNet_student(pl.LightningModule):
    ...
    def training_step(self,batch,batch_idx):
        ...
        loss = loss_fn(student_output, teacher_output, target , alpha=0.7, beta= .01, delta = 4, temperature=10)
    ...
    def configure_optimizers(self):
        ...
        optimizer = torch.optim.SGD(self.parameters(), lr=0.059916,weight_decay=1e-4, momentum=0.9,nesterov=True)
        ...
        scheduler = lr_scheduler.MultiStepLR(optimizer, milestones= [75,90,105], gamma=0.1)
...
checkpoint_callback = ModelCheckpoint(
     monitor='val_acc',
     dirpath=DIR,
     filename='student_10_ensamble_min18',
     mode='max'
 )
trainer=pl.Trainer(
    logger=True,
